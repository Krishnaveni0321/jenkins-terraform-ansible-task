   ...
   stages {
        stage('Checkout') {
            steps {
                ...
                sh 'https://github.com/Krishnaveni0321/jenkins-terraform-ansible-task.git' 
            }
        }
            ...
            steps {
                script {
                   sleep '360'
                    ...
                    ansiblePlaybook become: 'ubuntu', credentialsId: 'ubuntu', disableHostKeyChecking: true, installation: 'ansible', inventory: '/var/lib/jenkins/workspace/ansible-tf/ansible-task/inventory.yaml', playbook: '/var/lib/jenkins/workspace/ansible-tf/ansible-task/ubuntu-playbook.yml', vaultTmpPath: ''
                }
            }
        }
    }
